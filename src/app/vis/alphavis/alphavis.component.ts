...
export class AlphavisComponent implements OnInit {
  ...
  constructor(private uploadRs: FrameService, private uploadGt: GroundingService, private slidVal: SlideValueService, private router: Router, private headServc: HeaderService) { }
  ...
  plotChartLine(data: Data[], currentFrame: any): void {
    ...
    let result = this.headServc.getInvertColor();
